...
- Present perfect is used to describe the action that started in the past and is still happening now. (以前己經有做，現在仍然在做，但不一定會繼續做下去)
  ...
  - e.g. Prices have increased **by 2070 since last year** (Since + S V.ed).
  
### Usage of 'had better'
- is a **model verb** (e.g. should)
- had better + V.原形
...
e.g. 
- I am concerned with the news **(sth.)**.
- I am concerned about your health **(sth.)**.
...
### Usage of 'oppose/object/ be opposed to'
